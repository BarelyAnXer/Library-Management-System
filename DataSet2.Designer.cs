...
namespace FinalDisposable {
    ...
    public partial class DataSet2 : global::System.Data.DataSet {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public StudentsRow AddStudentsRow(string filename, string First_Name, string Last_Name, string Middle_Name, string address, string contact, string course, string gender, int Fee) {
        ...
        public partial class StudentsRow : global::System.Data.DataRow {
            ...
            public string filename {
                get {
                    try {
                        return ((string)(this[this.tableStudents.filenameColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'filename\' in table \'Students\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableStudents.filenameColumn] = value;
                }
            }
            ...
            public int Fee {
                get {
                    try {
                        return ((int)(this[this.tableStudents.FeeColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
            ...
            public bool IsfilenameNull() {
                return this.IsNull(this.tableStudents.filenameColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetfilenameNull() {
                this[this.tableStudents.filenameColumn] = global::System.Convert.DBNull;
            }
...
namespace FinalDisposable.DataSet2TableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Students] WHERE (([Id] = @Original_Id) AND ((@IsNull_filename = 1 AND [filename] IS NULL) OR ([filename] = @Original_filename)) AND ((@IsNull_First_Name = 1 AND [First_Name] IS NULL) OR ([First_Name] = @Original_First_Name)) AND ((@IsNull_Last_Name = 1 AND [Last_Name] IS NULL) OR ([Last_Name] = @Original_Last_Name)) AND ((@IsNull_Middle_Name = 1 AND [Middle_Name] IS NULL) OR ([Middle_Name] = @Original_Middle_Name)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_contact = 1 AND [contact] IS NULL) OR ([contact] = @Original_contact)) AND ((@IsNull_course = 1 AND [course] IS NULL) OR ([course] = @Original_course)) AND ((@IsNull_gender = 1 AND [gender] IS NULL) OR ([gender] = @Original_gender)) AND ((@IsNull_Fee = 1 AND [Fee] IS NULL) OR ([Fee] = @Original_Fee)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Students] ([filename], [First_Name], [Last_Name], [Middle_Name], [address], [contact], [course], [gender], [Fee]) VALUES (@filename, @First_Name, @Last_Name, @Middle_Name, @address, @contact, @course, @gender, @Fee);
SELECT Id, filename, First_Name, Last_Name, Middle_Name, address, contact, course, gender, Fee FROM Students WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Students] SET [filename] = @filename, [First_Name] = @First_Name, [Last_Name] = @Last_Name, [Middle_Name] = @Middle_Name, [address] = @address, [contact] = @contact, [course] = @course, [gender] = @gender, [Fee] = @Fee WHERE (([Id] = @Original_Id) AND ((@IsNull_filename = 1 AND [filename] IS NULL) OR ([filename] = @Original_filename)) AND ((@IsNull_First_Name = 1 AND [First_Name] IS NULL) OR ([First_Name] = @Original_First_Name)) AND ((@IsNull_Last_Name = 1 AND [Last_Name] IS NULL) OR ([Last_Name] = @Original_Last_Name)) AND ((@IsNull_Middle_Name = 1 AND [Middle_Name] IS NULL) OR ([Middle_Name] = @Original_Middle_Name)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_contact = 1 AND [contact] IS NULL) OR ([contact] = @Original_contact)) AND ((@IsNull_course = 1 AND [course] IS NULL) OR ([course] = @Original_course)) AND ((@IsNull_gender = 1 AND [gender] IS NULL) OR ([gender] = @Original_gender)) AND ((@IsNull_Fee = 1 AND [Fee] IS NULL) OR ([Fee] = @Original_Fee)));
SELECT Id, filename, First_Name, Last_Name, Middle_Name, address, contact, course, gender, Fee FROM Students WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, filename, First_Name, Last_Name, Middle_Name, address, contact, course" +
                ", gender, Fee FROM dbo.Students";
        ...
        public virtual int Delete(int Original_Id, string Original_filename, string Original_First_Name, string Original_Last_Name, string Original_Middle_Name, string Original_address, string Original_contact, string Original_course, string Original_gender, global::System.Nullable<int> Original_Fee) {
        ...
        public virtual int Insert(string filename, string First_Name, string Last_Name, string Middle_Name, string address, string contact, string course, string gender, global::System.Nullable<int> Fee) {
            if ((filename == null)) {
            ...
            if ((Fee.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[8].Value = ((int)(Fee.Value));
            }
            else {
        ...
        public virtual int Update(
            ...
            if ((Fee.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[8].Value = ((int)(Fee.Value));
            }
            else {
            ...
            if ((Original_Fee.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[27].Value = ((int)(Original_Fee.Value));
            }
            else {
        ...
        public virtual int Update(
                    ...
                    string Original_gender, 
                    global::System.Nullable<int> Original_Fee) {
            return this.Update(filename, First_Name, Last_Name, Middle_Name, address, contact, course, gender, Fee, Original_Id, Original_filename, Original_First_Name, Original_Last_Name, Original_Middle_Name, Original_address, Original_contact, Original_course, Original_gender, Original_Fee, Original_Id);
        }
    }
